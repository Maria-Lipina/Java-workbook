...
// Почувствуй себя сеньором ------------ Задачи добавились на семинаре 15.11.2021
...
// WriteLine();
// WriteLine("33. Задать массив из 12 элементов, заполненных числами из [0,9]. Найти сумму положительных/отрицательных элементов массива");
