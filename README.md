Репозиторий - это рабочая тетрадь. Основная цель: собрать вместе учебные упражнения и просто полезные куски кода. 
...
25. Реализовать двусвязный список + методы односвязного
